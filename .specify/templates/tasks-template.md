...
- [ ] T010 [P] Establish chain configuration and enforce chain-aware identity keys
- [ ] T011 [P] Establish i18n resource structure and locale formatter helpers
- [ ] T012 [P] Implement provider module boundaries (Moralis/Alchemy/RPC responsibilities)
- [ ] T013 Define coverage/confidence model primitives for partial analytics
...
- [ ] T022 [US1] Add translation keys and localized copy wiring (no hardcoded strings)
- [ ] T023 [US1] Verify chainId in query keys and API contracts for this story
